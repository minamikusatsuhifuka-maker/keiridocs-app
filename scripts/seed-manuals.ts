...
const MANUAL_TOPICS: Record<string, string[]> = {
  ...
  "機器操作・緊急時対応": [
    ...
    "停電・災害時の初動対応マニュアル",
    // 追加項目
    "アナフィラキシーショックの詳細対応手順（エピペン・薬剤投与）",
    "迷走神経反射（血管迷走神経性失神）の対応手順",
    "施術中の急変対応フロー",
    "局所麻酔によるアレルギー反応の対応",
    "過呼吸発作の対応手順",
    "レーザー施術中の熱傷・事故対応",
  ...
  "美容施術・皮膚科診療": [
    ...
    // 追加項目
    "ダーマペンの適応・禁忌・施術手順",
    "ケミカルピーリングの禁忌と施術前後の注意事項",
    "レーザー治療（Qスイッチ・炭酸ガス）の禁忌と手順",
    "ヒアルロン酸注射の詳細説明・禁忌・合併症対応",
    "ボトックス注射の適応・禁忌・施術手順",
    "エレクトロポレーションの施術手順と適応",
    "医療脱毛の施術前カウンセリングと同意書説明",
    "しみ・そばかす治療の種類と選択基準",
    "ニキビ跡治療の種類と患者説明",
    "美容点滴・注射メニューの説明と禁忌",
  ],
...
【作成ルール】
- 具体的で実践的な内容にする（実際の現場で使えるレベル）
- 手順がある場合は番号付きリストで記述
- 注意事項やポイントは「※」や「【注意】」で強調
- 禁忌がある場合は必ず「【禁忌】」として明記
- 必要な器具・材料がある場合は「【準備物】」として列挙
- 500〜800文字程度（詳細に記述すること）
- 日本語で作成
