...
小規模事業向けの経理書類管理 Web アプリケーション。書類の撮影・アップロード・メール取込から、AI による自動解析、Dropbox への保存、通知cd ~/keiridocs-app
npm run dev でローカルサーバーを起動し、ブラウザで localhost:3000/settings を開いて通知先追加を試してください。ターミナルに表示されるログを教えてください。まで一括管理できます。
